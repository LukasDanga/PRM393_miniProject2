...
class TaskDetailScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              final result = await Navigator.push<bool>(
                context,
                MaterialPageRoute(builder: (_) => AddEditTaskScreen(task: current)),
              );
              if (result == true && context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Đã cập nhật task', style: GoogleFonts.outfit()),
          ...
          IconButton(
            ...
            onPressed: () => _confirmDelete(context, db, current),
          ),
        ...
        child: Column(
          ...
          children: [
                ...
                GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: current.isCompleted ? const Color(0xFF059669) : Colors.transparent,
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(
                        color: current.isCompleted ? const Color(0xFF059669) : const Color(0xFFCBD5E1),
            ...
            Wrap(
              ...
              children: [
                ...
                if (category != null && categoryColor != null)
                  _buildCategoryChip(category.name, categoryColor, getIconData(category.icon)),
              ],
            ),
            ...
            _buildSection(
              ...
              title: 'Mô tả',
              child: current.description != null && current.description!.isNotEmpty
                  ? Text(
                      current.description!,
                      style: GoogleFonts.outfit(
                        fontSize: 15,
            ...
            _buildSection(
              ...
              child: current.dueDate != null
                  ? Row(
                      children: [
                        Text(
                          DateFormat('EEEE, dd/MM/yyyy').format(current.dueDate!),
                          style: GoogleFonts.outfit(
                            fontSize: 15,
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                icon: Icon(
                  current.isCompleted ? Icons.replay_rounded : Icons.check_rounded,
                  size: 20,
                ),
                label: Text(
                  current.isCompleted ? 'Đánh dấu chưa xong' : 'Đánh dấu hoàn thành',
  ...
  void _confirmDelete(BuildContext context, DatabaseService db, TaskModel task) async {
